...
function range(start,end,category,title){return Array.from({length:end-start+1},(_,i)=>{const n=start+i;return {id:n,image:`assets/images/page-${String(n).padStart(2,'0')}.jpg`,category,title:`${title} — Project ${n}`}})}
